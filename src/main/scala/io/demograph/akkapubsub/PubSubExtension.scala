...
object PubSubExtension extends ExtensionId[PubSubExtensionImpl] with ExtensionIdProvider {
  override val lookup: ExtensionId[PubSubExtensionImpl] = PubSubExtension

  override def createExtension(system: ExtendedActorSystem): PubSubExtensionImpl = new PubSubExtensionImpl
}
